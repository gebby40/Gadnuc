...
export default function TenantSettingsPage({ params }: Props) {
  const { slug } = params;
        ...
        {loading ? (
          ...
          <>
            ...
            <div style={{
              ...
              ℹ️ Gadnuc collects a <strong>{status.platform_fee_pct ?? 5}% platform fee</strong> on each order processed through your store.
            </div>
